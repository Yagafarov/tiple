        ...
        <Box py={4} sx={{ backgroundColor: theme.palette.primary.main, color: theme.palette.primary.contrastText }}>
            <Container>
                ...
                <Grid container alignItems="center" px={isMobile ? 2 : 9}>
                    {/* item 1 */}
                    <Grid item xs={12} md={6} display="flex" mb={{ xs: 3, sm: 10 }} sx={{ justifyContent: { xs: 'center', sm: 'start' } }}>
                        <Box
                            sx={{
                                backgroundColor: '#fff',
                                p: 2,
                    ...
                    <Grid item xs={12} md={6} mb={10}>
                        <Box px={isMobile ? 2 : 0} sx={{ textAlign: { xs: 'center', sm: 'start' } }}>
                    ...
                    <Grid item xs={12} md={6} display="flex" alignItems="center" order={{ xs: 2, md: 1 }} mb={10}>
                        <Box px={isMobile ? 2 : 0} sx={{ textAlign: { xs: 'center', sm: 'right' } }}>
                            <Typography variant={isMobile ? "h5" : "h4"} sx={{ mb: 2 }}>
                    ...
                    <Grid item xs={12} md={6} display="flex" order={{ xs: 1, md: 2 }} mb={{ xs: 3, sm: 10 }} sx={{ justifyContent: { xs: 'center', sm: 'end' } }}>
                        <Box
                            sx={{
                                backgroundColor: '#fff',
                                p: 2,
                ...
                <Grid container alignItems="center" px={isMobile ? 2 : 9}>
                    ...
                    <Grid item xs={12} md={6} display="flex" alignItems="center" order={{ xs: 2, md: 1 }} mb={10}>
                        <Box px={isMobile ? 2 : 0} sx={{ textAlign: { xs: 'center', sm: 'right' } }}>
                            ...
                            <Typography variant={isMobile ? "body1" : "h6"}>
                                {language === 'ru' ? 'Если гроубокс находится в помещении с отоплением, в квартире или доме, не имеет особого значения в какой именно период года вы занимаетесь выращиванием. Важно будет делать небольшие поправки в температурном режиме и влажности воздуха в период отопительного сезона.' : 'Agar o\'simlik boxi isitish bilan jihozlangan joyda, kvartirada yoki uyda bo\'lsa, qaysi yil faslida o\'simliklarni yetishtirayotganingiz muhim emas. Muhim bo\'ladi, isitish mavsumida harorat va havo namligida kichik o\'zgartirishlarni amalga oshirish.'}
                            </Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={12} md={6} display="flex" order={{ xs: 1, md: 2 }} mb={{ xs: 3, sm: 10 }} sx={{ justifyContent: { xs: 'center', sm: 'end' } }}>
